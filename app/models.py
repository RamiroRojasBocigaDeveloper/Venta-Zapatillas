...
class Producto(Base):
    ...
    precio_compra: Mapped[Decimal] = mapped_column(Numeric(14, 0), nullable=False, default=0)
    precio: Mapped[Decimal] = mapped_column(Numeric(14, 0), nullable=False)
...
class VentaDetalle(Base):
    ...
    precio_unitario: Mapped[Decimal] = mapped_column(Numeric(14, 0), nullable=False)
    precio_compra: Mapped[Optional[Decimal]] = mapped_column(Numeric(14, 0), nullable=True, default=0)
...
class Pago(Base):
    ...
    monto: Mapped[Decimal] = mapped_column(Numeric(14, 0), nullable=False)
